...
enum Direction2 {
    ...
    public Direction2 rotate(int num) {
        num = num % 4;
        if (num < 0) num += 4; // 음수일 경우 시계 반대방향으로 회전
...
public class Ex12_6_EnumEx2 {
    public static void main(String[] args) {
        for(Direction2 d : Direction2.values()) {
            System.out.printf("%s = %d\n", d.name(), d.getValue()); // EAST = 1, SOUTH = 2, WEST = 3, NORTH = 4
        }
        ...
        System.out.println(Direction2.EAST.rotate(1));  // SOUTHV
